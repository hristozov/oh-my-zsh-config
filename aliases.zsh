...
alias doc-remove-dangling-containers='docker rm -v $(docker ps --filter status=dead --filter status=exited -aq)'
alias doc-remove-dangling-images='docker rmi $(docker images -q -f dangling=true)'
alias doc-remove-dangling-volumes='docker volume rm $(docker volume ls -qf dangling=true)'
